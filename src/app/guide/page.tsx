...
const faqItems = [
  {
    ...
    answer:
      '배당률은 마권을 구매했을 때 적중 시 받을 수 있는 배수를 의미합니다. 예를 들어 배당률이 3.5배이면, 1,000원 구매 시 적중하면 3,500원을 받게 됩니다. 배당률은 경주 시작 전까지 실시간으로 변동됩니다.',
  },
  {
    question: '단승식과 복승식의 차이는 무엇인가요?',
    answer:
      '단승식은 1등을 정확히 맞추는 방식이고, 복승식은 1등과 2등을 순서와 관계없이 맞추는 방식입니다. 복승식이 적중 확률이 높아 배당률이 낮고, 단승식은 어려워 배당률이 높습니다.',
  },
  {
